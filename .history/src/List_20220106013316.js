...
const DeleteBtn = (props) => {
  return <button className="btn btn-sm btn-danger float-right">Delete</button>;
};

const EditBtn = (props) => {
  return <button className="btn btn-sm btn-warning float-right">Edit</button>;
};
...
class List extends Component {
  ...
  listItem(row, index, checked) {
    return (
      <li
        key={index}
        className="list-group-item d-flex align-items-right border-0 mb-2 rounded"
